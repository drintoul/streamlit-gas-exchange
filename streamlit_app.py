...
def main():
	...
	if cdn:
		...
		amount = st.slider("Enter Amount of gas in Litres", value=5.0, min_value=1, max_value=10.0)
		...
		amount = st.slider("Enter Amount of gas in gallons", value=5.0, min_value=1, max_value=10.0)
